...
The action verifies cryptographic integrity and protocol semantics. It does not
admit the result into a comparison cohort or trust a self-signed operator key.

## Packages

| Package | Responsibility |
| --- | --- |
| [`moemodels`](packages/moemodels) | Public Plan → Run → Verify launcher |
...
Read the [DeployBench v0.1 protocol draft](docs/DEPLOYBENCH_V0_1.md) and
[Evidence Passport v0.2 methodology](docs/DEPLOYMENT_PASSPORT_V0_2.md) before
publishing or comparing results.
...
The package smoke test packs all nine workspaces, installs the tarballs in an
empty temporary project, and executes the public launcher, SDK, and MCP server.
