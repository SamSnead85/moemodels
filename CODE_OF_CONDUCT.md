...
reported through the repository owner's private conduct-reporting channel. When
hosted on GitHub, use a private contact path listed on the owner or organization
profile; do not put sensitive conduct reports in a public issue. If no private
channel is listed, ask the repository owner to provide one before sending details.

All complaints will be reviewed and investigated promptly and fairly to the extent
reasonably possible. Community leaders are obligated to respect the privacy and
